...
public class NaverLoginBO {
	...
	private final static String CLIENT_ID = "fY12V77yD4Hif6OLjt3G";
	private final static String CLIENT_SECRET = "VtLdOgtsho";
	private final static String REDIRECT_URI = "http://localhost:8080/project/callback.com";
